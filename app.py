...
# Наша "База данных" (пока в памяти). Твой аккаунт уже тут с правами админа!
users = {
    "maloshko": {
...
def login():
    ...
    if user and user['password'] == password:
        # Не отправляем пароль на фронтенд для безопасности
...
def get_all_users():
    ...
    # Проверяем, админ ли запрашивает
...
def admin_action():
    ...
    action = data.get('action') # 'give_sub' или 'give_admin'
